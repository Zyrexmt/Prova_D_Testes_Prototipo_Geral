          ...
          child: Container(
            ...
            Stack(
              children: [
                ...
                maxScale: 4.0,
                child: Image.file(
                  imagemSelecionada!,width: double.infinity, height: double.infinity, fit: BoxFit.cover,
                ),),
              ...
              : Center(
                child: Icon(Icons.add_photo_alternate_outlined, size: 40, color: corRoxoEscuro,),
              )
          ),
        ),
      ],
          ...
          children: [
            TextButton(
              ...
              style: TextButton.styleFrom(
                ...
                shape: RoundedRectangleBorder(borderRadius: BorderRadiusGeometry.horizontal()),
                fixedSize: Size(70, 40),
              ),
              child: Text('Salvar', style: regular),
            ),
            TextButton(
              onPressed: () => Navigator.of(context).pushReplacementNamed('/teachers'),
              style: TextButton.styleFrom(
                backgroundColor: corRoxoEscuro,
                foregroundColor: corClara,
                shape: RoundedRectangleBorder(borderRadius: BorderRadiusGeometry.horizontal()),
